"""
insect_blast.py — BLASTN against target insect genomes.
"""
...
class InsectBlastInput(BaseModel):
    ...
    sequence: str = Field(description="Query sequence (5'→3'), typically primer (18-25nt) or siRNA (19-21nt)")
    species: str = Field(description="Target insect (Latin, underscore-separated), e.g. Bombyx_mori")
